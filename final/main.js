  ...
  if (populationData != null) {
    ...
    for (let i = 0; i < populationData.length; i++) {
      if (districtName == populationData[i].District) {  //比對到區名
         if (PopulationSelect.value == "Year113") {
          populationValue = populationData[i].Year113;  //取得Year113的數值
        }
        ...
        else if (PopulationSelect.value == "Year106") {
          populationValue = populationData[i].Year106;  //取得Year106的數值
        }
        else if (PopulationSelect.value == "Year105") {
          populationValue = populationData[i].Year108;  //取得Year105的數值
        }
        else if (PopulationSelect.value == "Year104") {
          populationValue = populationData[i].Year107;  //取得Year104的數值
        }
        else if (PopulationSelect.value == "Year103") {
          populationValue = populationData[i].Year103;  //取得Year103的數值
        }
      }
    }
  }
